...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1775624104);
user_pref("app.update.lastUpdateTime.background-update-timer", 1775624104);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1775624104);
user_pref("app.update.lastUpdateTime.region-update-timer", 1775624104);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1775624802);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1775624104);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1775624104);
user_pref("app.update.migrated.updateDir3.4906CA5F7EA9FC7D", true);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "65cb7bdb-b10c-435e-b00c-439716baf2af");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1775623990);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{00bf3eb9-8865-4dbc-ad4e-0b1e08cd39e6}");
...
user_pref("browser.startup.lastColdStartupCheck", 1775624802);
...
user_pref("captchadetection.lastSubmission", 1775623);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "11fb0a3c-4d01-4295-9774-20ae4b36b80d");
user_pref("datareporting.dau.cachedUsageProfileID", "beec9612-65cb-4002-9c64-e97ff7552338");
...
user_pref("extensions.webextensions.uuids", "{\"data-leak-blocker@mozilla.com\":\"5bcfea5d-2fa1-468a-8429-89664165406d\",\"formautofill@mozilla.org\":\"79f30c7a-9902-4d1a-ad46-a1d224ab4436\",\"ipp-activator@mozilla.com\":\"e5b60ae7-4d07-43fe-815a-263b1edb7651\",\"pictureinpicture@mozilla.org\":\"bdec5e4f-affa-4a7a-82ec-7928f93b3202\",\"addons-search-detection@mozilla.com\":\"c8daf08c-3c34-4e44-95e0-3b379bda3dc3\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"newtab@mozilla.org\":\"dbb9951f-8fa6-4fa1-9781-38dc3bef5428\",\"default-theme@mozilla.org\":\"4918ac96-ece6-4d34-8826-d794a1c95279\"}");
...
user_pref("media.gmp-manager.lastCheck", 1775624125);
user_pref("media.gmp-manager.lastEmptyCheck", 1775624125);
...
user_pref("nimbus.profileId", "1c6197c9-9f84-4aa8-8925-22273e9880f0");
...
user_pref("toolkit.profiles.storeID", "d980ec52");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1775624800);
